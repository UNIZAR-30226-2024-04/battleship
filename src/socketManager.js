...
function initializeSocket(server) {
    ...
    io.on('connection', socket => {
        ...
        socket.on(eventosSocket.resultadoTurno, (codigo, coordenada, habilidad) => {
            console.log('Resultado turno tras disparo recibido en backend:', codigo);
            io.to(`/partida${codigo['codigo']}`).emit(eventosSocket.resultadoTurno, codigo, coordenada, habilidad);
        });
